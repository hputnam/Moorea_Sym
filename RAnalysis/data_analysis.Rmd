...
include <- c("mean", "var", "dip", "daily.mean.min", "daily.mean.max", "daily.mean.range", "daysover30", "daysunder27", "daily.mean.var")
...
rad <- radarchart(
  ...
  #custom labels
  vlcex=1, 
  vlabels = c("Mean", "Mean Daily Range", "Variance", "Days over 30", "Days under 27")
)
title("c", adj=0.05, line = 0)
legend("topright", rownames(temp2)[-(1:2)], lty=1, lwd=2, col=sitecolors, bty="n", 
       cex=0.9, ncol=2, inset=c(-0.02,-0.05))
dev.off()
```
