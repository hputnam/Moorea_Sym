...
# Figure 1
```{r Fig1, eval=T}
tiff("Output/Fig1.tiff", width=7, height=2.5, units="in", res=300)
par(mfrow=c(1,3), mgp=c(1,0.1,0), tcl=0.25, cex.lab=1, cex.axis=0.8,
    mar=c(2,2,2,2))
layout(matrix(c(1,2,3), nrow=1, ncol=3, byrow = TRUE), heights=c(1,1,1))
...
# Panel B
biplot(pca.temp, cex=0.8, bty="n", xpd=NA,expand=0.65)
title("b", adj=0)
