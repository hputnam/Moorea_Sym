...
sample_data(phy.f)$mean <- sample_data(phy.f)$Site
sample_data(phy.f)$mean <- gsub(" Site 1",temp.summ[1,1],as.character(data.frame(sample_data(phy.f))$mean))
sample_data(phy.f)$mean <- gsub(" Site 2",temp.summ[2,1],as.character(data.frame(sample_data(phy.f))$mean))
sample_data(phy.f)$mean <- gsub(" Site 3",temp.summ[3,1],as.character(data.frame(sample_data(phy.f))$mean))
sample_data(phy.f)$mean <- gsub(" Site 7",temp.summ[4,1],as.character(data.frame(sample_data(phy.f))$mean))
sample_data(phy.f)$mean <- gsub(" Site 8",temp.summ[5,1],as.character(data.frame(sample_data(phy.f))$mean))
sample_data(phy.f)$mean <- gsub(" Site 9",temp.summ[6,1],as.character(data.frame(sample_data(phy.f))$mean))

sample_data(phy.f)$var <- sample_data(phy.f)$Site
sample_data(phy.f)$var <- gsub(" Site 1",temp.summ[1,2],as.character(data.frame(sample_data(phy.f))$var))
sample_data(phy.f)$var <- gsub(" Site 2",temp.summ[2,2],as.character(data.frame(sample_data(phy.f))$var))
sample_data(phy.f)$var <- gsub(" Site 3",temp.summ[3,2],as.character(data.frame(sample_data(phy.f))$var))
sample_data(phy.f)$var <- gsub(" Site 7",temp.summ[4,2],as.character(data.frame(sample_data(phy.f))$var))
sample_data(phy.f)$var <- gsub(" Site 8",temp.summ[5,2],as.character(data.frame(sample_data(phy.f))$var))
sample_data(phy.f)$var <- gsub(" Site 9",temp.summ[6,2],as.character(data.frame(sample_data(phy.f))$var))

sample_data(phy.f)$skew <- sample_data(phy.f)$Site
sample_data(phy.f)$skew <- gsub(" Site 1",temp.summ[1,5],as.character(data.frame(sample_data(phy.f))$skew))
sample_data(phy.f)$skew <- gsub(" Site 2",temp.summ[2,5],as.character(data.frame(sample_data(phy.f))$skew))
sample_data(phy.f)$skew <- gsub(" Site 3",temp.summ[3,5],as.character(data.frame(sample_data(phy.f))$skew))
sample_data(phy.f)$skew <- gsub(" Site 7",temp.summ[4,5],as.character(data.frame(sample_data(phy.f))$skew))
sample_data(phy.f)$skew <- gsub(" Site 8",temp.summ[5,5],as.character(data.frame(sample_data(phy.f))$skew))
sample_data(phy.f)$skew <- gsub(" Site 9",temp.summ[6,5],as.character(data.frame(sample_data(phy.f))$skew))

sample_data(phy.f)$dip <- sample_data(phy.f)$Site
sample_data(phy.f)$dip <- gsub(" Site 1",temp.summ[1,6],as.character(data.frame(sample_data(phy.f))$dip))
sample_data(phy.f)$dip <- gsub(" Site 2",temp.summ[2,6],as.character(data.frame(sample_data(phy.f))$dip))
sample_data(phy.f)$dip <- gsub(" Site 3",temp.summ[3,6],as.character(data.frame(sample_data(phy.f))$dip))
sample_data(phy.f)$dip <- gsub(" Site 7",temp.summ[4,6],as.character(data.frame(sample_data(phy.f))$dip))
sample_data(phy.f)$dip <- gsub(" Site 8",temp.summ[5,6],as.character(data.frame(sample_data(phy.f))$dip))
sample_data(phy.f)$dip <- gsub(" Site 9",temp.summ[6,6],as.character(data.frame(sample_data(phy.f))$dip))

sample_data(phy.f)$daily.mean.min <- sample_data(phy.f)$Site
sample_data(phy.f)$daily.mean.min <- gsub(" Site 1",temp.summ[1,7],as.character(data.frame(sample_data(phy.f))$daily.mean.min))
sample_data(phy.f)$daily.mean.min <- gsub(" Site 2",temp.summ[2,7],as.character(data.frame(sample_data(phy.f))$daily.mean.min))
sample_data(phy.f)$daily.mean.min <- gsub(" Site 3",temp.summ[3,7],as.character(data.frame(sample_data(phy.f))$daily.mean.min))
sample_data(phy.f)$daily.mean.min <- gsub(" Site 7",temp.summ[4,7],as.character(data.frame(sample_data(phy.f))$daily.mean.min))
sample_data(phy.f)$daily.mean.min <- gsub(" Site 8",temp.summ[5,7],as.character(data.frame(sample_data(phy.f))$daily.mean.min))
sample_data(phy.f)$daily.mean.min <- gsub(" Site 9",temp.summ[6,7],as.character(data.frame(sample_data(phy.f))$daily.mean.min))

sample_data(phy.f)$daily.mean.max <- sample_data(phy.f)$Site
sample_data(phy.f)$daily.mean.max <- gsub(" Site 1",temp.summ[1,8],as.character(data.frame(sample_data(phy.f))$daily.mean.max))
sample_data(phy.f)$daily.mean.max <- gsub(" Site 2",temp.summ[2,8],as.character(data.frame(sample_data(phy.f))$daily.mean.max))
sample_data(phy.f)$daily.mean.max <- gsub(" Site 3",temp.summ[3,8],as.character(data.frame(sample_data(phy.f))$daily.mean.max))
sample_data(phy.f)$daily.mean.max <- gsub(" Site 7",temp.summ[4,8],as.character(data.frame(sample_data(phy.f))$daily.mean.max))
sample_data(phy.f)$daily.mean.max <- gsub(" Site 8",temp.summ[5,8],as.character(data.frame(sample_data(phy.f))$daily.mean.max))
sample_data(phy.f)$daily.mean.max <- gsub(" Site 9",temp.summ[6,8],as.character(data.frame(sample_data(phy.f))$daily.mean.max))

sample_data(phy.f)$daily.mean.range <- sample_data(phy.f)$Site
sample_data(phy.f)$daily.mean.range <- gsub(" Site 1",temp.summ[1,9],as.character(data.frame(sample_data(phy.f))$daily.mean.range))
sample_data(phy.f)$daily.mean.range <- gsub(" Site 2",temp.summ[2,9],as.character(data.frame(sample_data(phy.f))$daily.mean.range))
sample_data(phy.f)$daily.mean.range <- gsub(" Site 3",temp.summ[3,9],as.character(data.frame(sample_data(phy.f))$daily.mean.range))
sample_data(phy.f)$daily.mean.range <- gsub(" Site 7",temp.summ[4,9],as.character(data.frame(sample_data(phy.f))$daily.mean.range))
sample_data(phy.f)$daily.mean.range <- gsub(" Site 8",temp.summ[5,9],as.character(data.frame(sample_data(phy.f))$daily.mean.range))
sample_data(phy.f)$daily.mean.range <- gsub(" Site 9",temp.summ[6,9],as.character(data.frame(sample_data(phy.f))$daily.mean.range))

sample_data(phy.f)$daysover30 <- sample_data(phy.f)$Site
sample_data(phy.f)$daysover30 <- gsub(" Site 1",temp.summ[1,10],as.character(data.frame(sample_data(phy.f))$daysover30))
sample_data(phy.f)$daysover30 <- gsub(" Site 2",temp.summ[2,10],as.character(data.frame(sample_data(phy.f))$daysover30))
sample_data(phy.f)$daysover30 <- gsub(" Site 3",temp.summ[3,10],as.character(data.frame(sample_data(phy.f))$daysover30))
sample_data(phy.f)$daysover30 <- gsub(" Site 7",temp.summ[4,10],as.character(data.frame(sample_data(phy.f))$daysover30))
sample_data(phy.f)$daysover30 <- gsub(" Site 8",temp.summ[5,10],as.character(data.frame(sample_data(phy.f))$daysover30))
sample_data(phy.f)$daysover30 <- gsub(" Site 9",temp.summ[6,10],as.character(data.frame(sample_data(phy.f))$daysover30))

sample_data(phy.f)$daysunder27.5 <- sample_data(phy.f)$Site
sample_data(phy.f)$daysunder27.5 <- gsub(" Site 1",temp.summ[1,13],as.character(data.frame(sample_data(phy.f))$daysunder27.5))
sample_data(phy.f)$daysunder27.5 <- gsub(" Site 2",temp.summ[2,13],as.character(data.frame(sample_data(phy.f))$daysunder27.5))
sample_data(phy.f)$daysunder27.5 <- gsub(" Site 3",temp.summ[3,13],as.character(data.frame(sample_data(phy.f))$daysunder27.5))
sample_data(phy.f)$daysunder27.5 <- gsub(" Site 7",temp.summ[4,13],as.character(data.frame(sample_data(phy.f))$daysunder27.5))
sample_data(phy.f)$daysunder27.5 <- gsub(" Site 8",temp.summ[5,13],as.character(data.frame(sample_data(phy.f))$daysunder27.5))
sample_data(phy.f)$daysunder27.5 <- gsub(" Site 9",temp.summ[6,13],as.character(data.frame(sample_data(phy.f))$daysunder27.5))
...
## Now look at Acropora and Porites separately
phy.f.porites <- subset_samples(phy.f,Species=="Porties")
phy.f.acropora <- subset_samples(phy.f,Species=="Acropora")
ord.porites <- ordinate(phy.f.porites,"PCoA", "wunifrac")
ord.acropora <- ordinate(phy.f.acropora,"PCoA", "wunifrac")

plot_ordination(phy.f.porites,ord.porites,color="Site",type="sample",
                title="97% within-sample OTUs, Porites only")
plot_ordination(phy.f.porites,ord.porites,color="Clade",type="species",
                title="97% within-sample OTUs, Porites only")

plot_ordination(phy.f.acropora,ord.acropora,color="Site",type="sample",
                title="97% within-sample OTUs, acropora only")
plot_ordination(phy.f.acropora,ord.acropora,color="Clade",type="species",
                title="97% within-sample OTUs, acropora only")
