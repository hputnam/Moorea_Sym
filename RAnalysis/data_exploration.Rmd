...
hist(temp.all$Site.1, xlim=c(26.5,31.5), breaks=20, main="Site 1", xlab="Temp °C")
hist(temp.all$Site.2, xlim=c(26.5,31.5), breaks=20, main="Site 2", xlab="Temp °C")
hist(temp.all$Site.3, xlim=c(26.5,31.5), breaks=20, main="Site 3", xlab="Temp °C")
hist(temp.all$Site.7, xlim=c(26.5,31.5), breaks=20, main="Site 7", xlab="Temp °C")
hist(temp.all$Site.8, xlim=c(26.5,31.5), breaks=20, main="Site 8", xlab="Temp °C")
hist(temp.all$Site.9, xlim=c(26.5,31.5), breaks=20, main="Site 9", xlab="Temp °C")
...
ord <- ordinate(phy.f, "NMDS", distance = "bray", trymax=100)
plot_ordination(phy.f, ord)
pcoa <- ordinate(phy.f.p, "PCoA", distance="bray", trymax=100)
p3<-plot_ordination(phy.f, pcoa, type="sample", color="Species")
print(p3)
...
phy.f.por.no <- subset_samples(phy.f,DNA.ID!="209122")
phy.f.por.122 <- subset_samples(phy.f,DNA.ID=="209122",prune=TRUE)
phy.f.por.122 <- subset_taxa(phy.f.por.122,taxa_sums(phy.f.por.122)>0,prune=TRUE)
...
ord4 <- ordinate(phy.f.por.no, "NMDS", distance = "bray", trymax=100)
plot_ordination(phy.f.por.no, ord4,color="Site")
ord5 <- ordinate(phy.f.por.no, "PCoA", distance = "bray", trymax=100)
plot_ordination(phy.f.por.no, ord5,color="Site")
